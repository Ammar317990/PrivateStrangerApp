...
export default function DirectChatStarter({
  ...
  return (
    <form
      ...
      className="flex flex-1 flex-col items-center justify-center gap-4 rounded-lg border border-neutral-800 p-8 text-center"
    >
      ...
      <div className="flex w-full max-w-xs gap-2">
        ...
        <button
          ...
          className="rounded-md border border-neutral-700 px-4 py-2 text-sm font-medium transition hover:border-neutral-500 disabled:opacity-50"
        >
